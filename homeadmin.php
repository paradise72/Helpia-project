...
<body>
    <header>
        <nav>
            <div class="logo"><p>  HELPIA: &nbsp; 
                Welcome to helpia Admin platform &nbsp;
                <a href="database1.php">Database</a></p> 
    ...
    <section id="features" class="features">
        ...
        <div class="feature" onclick="displayContent('content1')">
            <img src="untitled23.jpeg" alt="Feature 1" height="120" width="90%">
            <h3>ALL CONTENT FOR ENGLISH LANGUAGES</h3>
            <p>Learn in Kinyarwanda and English.</p>
        </div>

        <div class="feature" onclick="displayContent('content2')">
            <img src="untitled1.jpeg" alt="Feature 1">
            <h3>ALL CONTENT FOR KINYARWANDA LANGUAGES</h3>
            <p>Engage with images and words.</p>
        </div>
        <div class="feature" onclick="displayContent('content3')">
            <img src="te.jpeg" alt="Feature 1">
            <h3>ALL TEACHERS IN HELPIA</h3>
            <p>Monitor your child's learning journey.</p>
        </div>
        <div class="feature" onclick="displayContent('content4')">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrcV8CPt2JQPbxODNwNH-zqpIOJI-zLmwy23Do6pdwutdu7qj_q0CGq8pCp0MQ3Pq25Zs&usqp=CAU" alt="Feature 1">
                    <h3>ALL STUDENTS FOR HELPIA</h3>
